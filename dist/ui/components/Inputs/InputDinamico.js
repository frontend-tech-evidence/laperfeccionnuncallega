class InputDinamico extends HTMLElement {
    constructor() {
        super();
            ...
            <div class="relative rounded-md shadow-sm">                    
                <div id="inputContainer${idCapitalize}" class="flex items-center gap-x-3 border border-gray-900/10 mt-1 rounded-md shadow-sm">                 
                    ...
                    <div class="relative w-full">                                                                
                        <input placeholder="${placeholder}" type="${inputTipo}" name="${id}" id="input${idCapitalize}" class="rounded-md w-full py-2 pl-3 text-gray-900 border-0 text-sm leading-6">
...
if ('customElements' in window) {
    customElements.define('input-dinamico', InputDinamico);
}
