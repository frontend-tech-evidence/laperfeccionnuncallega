class SectonInfo extends HTMLElement {
    constructor() {
        ...
        const exitIconDefaultVisibility = this.getAttribute('exitIconDefaultVisibility');
        const showIconDefaultVisibility = this.getAttribute('showIconDefaultVisibility');
        const wantToChangeIconDefaultVisibility = this.getAttribute('wantToChangeIconDefaultVisibility');
