class PdfCotizacion extends HTMLElement {
    constructor() {
        ...
        const modalidadPagoMembresiaCorta = packageInformation.isModalidadRentaMensual ? 'mes' : 'año';
        const modalidadPagoImplementacionCorta = packageInformation.isPagoImplementacionMensual ? 'mes' : 'año';
        // Render HTML
        this.innerHTML = `   
